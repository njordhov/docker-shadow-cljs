...
var i_51228 = (0);
while(true){
if((i_51228 < arr.length)){
(arr[i_51228] = null);

var G__51229 = (i_51228 + (1));
i_51228 = G__51229;
continue;
} else {
}
...
var i_51236 = (self__.level + (1));
while(true){
if((i_51236 <= (new_level + (1)))){
(update[i_51236] = self__.header);

var G__51237 = (i_51236 + (1));
i_51236 = G__51237;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_51238 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_51238[i]));
} else {
x__$2.forward.push((((i < links_51238.length))?(links_51238[i]):null));
}

if((i < links_51238.length)){
(links_51238[i] = x__$2);
} else {
links_51238.push(x__$2);
}
...
var i_51240 = (0);
while(true){
if((i_51240 <= self__.level)){
var links_51241 = (update[i_51240]).forward;
if((x__$1 === (((i_51240 < links_51241.length))?(links_51241[i_51240]):null))){
(links_51241[i_51240] = (x__$1.forward[i_51240]));

var G__51242 = (i_51240 + (1));
i_51240 = G__51242;
continue;
} else {
var G__51243 = (i_51240 + (1));
i_51240 = G__51243;
continue;
}
} else {
...
var G__51245 = nx;
var G__51246 = (level__$1 - (1));
x = G__51245;
level__$1 = G__51246;
continue;
} else {
var G__51247 = x;
var G__51248 = (level__$1 - (1));
x = G__51247;
level__$1 = G__51248;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__51250 = nx;
var G__51251 = (level__$1 - (1));
x = G__51250;
level__$1 = G__51251;
continue;
} else {
var G__51252 = x;
var G__51253 = (level__$1 - (1));
x = G__51252;
level__$1 = G__51253;
continue;
}
