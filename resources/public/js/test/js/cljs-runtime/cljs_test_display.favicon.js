...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__58063_SHARP_){
return html_coll.item(p1__58063_SHARP_);
...
return cljs.core.some((function (p1__58064_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("icon",p1__58064_SHARP_);
...
var ctx_58065 = cvs.getContext("2d");
(ctx_58065.fillStyle = color);

ctx_58065.fillRect((0),(0),size,size);
