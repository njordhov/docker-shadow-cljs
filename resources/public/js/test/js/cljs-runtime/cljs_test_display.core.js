...
var node = (function (){var G__58083 = new cljs.core.Keyword(null,"style","style",-496642736);
var G__58084 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"id","id",-1388402092),"cljs-test-display-style"], null);
var G__58085 = style_string_58113;
return (cljs_test_display.core.n.cljs$core$IFn$_invoke$arity$3 ? cljs_test_display.core.n.cljs$core$IFn$_invoke$arity$3(G__58083,G__58084,G__58085) : cljs_test_display.core.n.call(null,G__58083,G__58084,G__58085));
})();
...
var len__5769__auto___58114 = arguments.length;
var i__5770__auto___58115 = (0);
while(true){
if((i__5770__auto___58115 < len__5769__auto___58114)){
args__5775__auto__.push((arguments[i__5770__auto___58115]));

var G__58116 = (i__5770__auto___58115 + (1));
i__5770__auto___58115 = G__58116;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs_test_display.core.n.cljs$lang$applyTo = (function (seq58086){
var G__58087 = cljs.core.first(seq58086);
var seq58086__$1 = cljs.core.next(seq58086);
var G__58088 = cljs.core.first(seq58086__$1);
var seq58086__$2 = cljs.core.next(seq58086__$1);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__58087,G__58088,seq58086__$2);
}));
...
var vec__58089 = ((clojure.string.starts_with_QMARK_(cljs.core.first(classes),"#"))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.first(classes),(1)),cljs.core.rest(classes)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,classes], null));
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58089,(0),null);
var classes__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58089,(1),null);
var G__58092 = cljs.core.PersistentArrayMap.EMPTY;
var G__58092__$1 = (cljs.core.truth_(id)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__58092,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__58092);
if(cljs.core.truth_(cljs.core.not_empty(classes__$1))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__58092__$1,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",classes__$1));
} else {
return G__58092__$1;
}
} else {
...
return (function() { 
var G__58117__delegate = function (klass,contents){
var vec__58093 = (((klass instanceof cljs.core.Keyword))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [klass,contents], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,cljs.core.cons(klass,contents)], null));
var klass__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58093,(0),null);
var contents__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58093,(1),null);
...
var G__58117 = function (klass,var_args){
var contents = null;
...
while (G__58118__i < G__58118__a.length) {G__58118__a[G__58118__i] = arguments[G__58118__i + 1]; ++G__58118__i;}
  contents = new cljs.core.IndexedSeq(G__58118__a,0,null);
} 
return G__58117__delegate.call(this,klass,contents);};
G__58117.cljs$lang$maxFixedArity = 1;
G__58117.cljs$lang$applyTo = (function (arglist__58119){
var klass = cljs.core.first(arglist__58119);
var contents = cljs.core.rest(arglist__58119);
return G__58117__delegate(klass,contents);
});
...
cljs_test_display.core.process_file_name = (function cljs_test_display$core$process_file_name(p__58098){
var map__58099 = p__58098;
var map__58099__$1 = cljs.core.__destructure_map(map__58099);
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58099__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58099__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs_test_display.core.comparison = (function cljs_test_display$core$comparison(p__58100){
var map__58101 = p__58100;
var map__58101__$1 = cljs.core.__destructure_map(map__58101);
var actual = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58101__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
var expected = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58101__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
...
cljs_test_display.core.error_comparison = (function cljs_test_display$core$error_comparison(p__58102){
var map__58103 = p__58102;
var map__58103__$1 = cljs.core.__destructure_map(map__58103);
var expected = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58103__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
var actual = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58103__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),(function (p1__58104_SHARP_){
return cljs.core.cons(new_current_node,p1__58104_SHARP_);
}));
...
var curr_node = cljs_test_display.core.current_node();
var map__58106 = cljs_test_display.core.current_var_info();
var map__58106__$1 = cljs.core.__destructure_map(map__58106);
var info = map__58106__$1;
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58106__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58106__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58106__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),(function (p1__58105_SHARP_){
return cljs.core.cons(node,p1__58105_SHARP_);
}));

return goog.dom.appendChild(curr_node,node);
});
cljs_test_display.core.summary = (function cljs_test_display$core$summary(p__58107){
var map__58108 = p__58107;
var map__58108__$1 = cljs.core.__destructure_map(map__58108);
var m = map__58108__$1;
var fail = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58108__$1,new cljs.core.Keyword(null,"fail","fail",1706214930));
var error = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58108__$1,new cljs.core.Keyword(null,"error","error",-978969032));
var pass = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58108__$1,new cljs.core.Keyword(null,"pass","pass",1574159993));
var test = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58108__$1,new cljs.core.Keyword(null,"test","test",577538877));
...
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["expected:",(function (){var G__58109 = new cljs.core.Keyword(null,"expected","expected",1583670997).cljs$core$IFn$_invoke$arity$1(m);
return (formatter_fn.cljs$core$IFn$_invoke$arity$1 ? formatter_fn.cljs$core$IFn$_invoke$arity$1(G__58109) : formatter_fn.call(null,G__58109));
})()], 0));

return cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["  actual:",(function (){var G__58110 = new cljs.core.Keyword(null,"actual","actual",107306363).cljs$core$IFn$_invoke$arity$1(m);
return (formatter_fn.cljs$core$IFn$_invoke$arity$1 ? formatter_fn.cljs$core$IFn$_invoke$arity$1(G__58110) : formatter_fn.call(null,G__58110));
})()], 0));
});
...
var temp__5804__auto___58121 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5804__auto___58121)){
var message_58122 = temp__5804__auto___58121;
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([message_58122], 0));
} else {
}
...
var temp__5804__auto___58123 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5804__auto___58123)){
var message_58124 = temp__5804__auto___58123;
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([message_58124], 0));
} else {
}
